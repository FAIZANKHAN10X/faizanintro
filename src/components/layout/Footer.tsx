      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-32">
          <TrackedLink
            ...
            tracking={{
              name: "booking_click",
              params: { location: "footer_headline", label: "Let's Build" },
            }}
        ...
        {/* 3. Bottom Bar */}
        <div className="pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-mono text-neutral-600 uppercase tracking-widest">
